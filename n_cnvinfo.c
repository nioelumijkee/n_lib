...
{
  n_cnvinfo_class = class_new(gensym("n_cnvinfo"), (t_newmethod)n_cnvinfo_new, 0, sizeof(t_n_cnvinfo), 0, A_GIMME, 0);
  class_addbang(n_cnvinfo_class, (t_method)n_cnvinfo_canvas);
  class_addmethod(n_cnvinfo_class, (t_method)n_cnvinfo_canvas, gensym("canvas"), A_DEFFLOAT, 0);
}
